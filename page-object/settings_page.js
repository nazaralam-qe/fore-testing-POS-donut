...
class SettingPage {
    ...
    async changePassStore() {
        ...
        await Helper.sendText(SettingKey.CHANGE_PASS_STORE_OLD,"123123123");
    ...
    async changePassStoreDefault() {
        ...
        await Expect.clickElement(SettingKey.CHANGE_PASS_STORE_OLD_VISIBLE);
        await Helper.sendText(SettingKey.CHANGE_PASS_STORE_NEW,"123123123");
        await Expect.clickElement(SettingKey.CHANGE_PASS_STORE_NEW_VISIBLE);
        await Helper.sendText(SettingKey.CHANGE_PASS_STORE_CONFIRM,"123123123");
        await Expect.clickElement(SettingKey.CHANGE_PASS_STORE_CONFIRM_VISIBLE);
        await Expect.clickElement(SettingKey.CHANGE_PASS_STORE_SUBMIT_BTN);
    }
    ...
    async userLogOut() {
        await Expect.clickElement(SettingKey.CHECK_LOG_OUT);
        await driver.pause(2000);
        await Expect.clickElement(SettingKey.POPUP_LOG_OUT);
        await driver.pause(2000);
    }
    ...
    async setDevApi2() {
        ...
        await Expect.clickElement(SettingKey.SETTING_DEBUG_CONFIGURE_BUTTON);
        await Expect.clickElement(SettingKey.SETTING_DEBUG_CONFIGURE_SYS_VALUE_ADJUSTER);
        await Expect.clickElement(SettingKey.SETTING_DEBUG_CHANGE_BASE_URL);
        await Expect.clickElement(SettingKey.SETTING_DEBUG_CHANGE_DEVAPI2);
        await Expect.clickElement(SettingKey.SETTING_DEBUG_RESTART_POS);
        await driver.pause(2000);
    }
